...
import { IProjectDescription } from "src/modules/project/schemas/description.schema.js";

/**
 * Extracts @description comments from code nodes
 */
export function extractDescriptions(project: Project): IProjectDescription[] {
    const descriptions: IProjectDescription[] = [];
